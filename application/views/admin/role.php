...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-primary mb-3 " data-toggle="modal" data-target="#newRole">Add New Role Menu</a>
                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo anchor('admin/delete_role/'.$r['id'],'<i  class="fa fa-trash "> Delete</i>')?>
                                 </div>
