...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-info bg-info fixed-top">
    <marquee class="navbar-brand col-sm-10 text-white" href="#"><strong>WELCOME TO <span class="fa fa-book"> </span> AGENDA SURAT MASUK</strong></marquee>
    <div class="container">
  ...
  <div class="container">
    ...
    <div class="row">
            ...
            <form action="<?= base_url('surat_masuk/agenda'); ?>" method="post">
            <div class="input-group col-md-5">
            <input type="text" class="form-control" placeholder="Masukan No Agenda/No Surat/Asal Surat" name="keyword">
      ...
      <div><a class="btn btn-sm btn-danger mt-2 ml-5" href="<?= base_url('surat_masuk/cetak_agenda'); ?>" target="_blank"><strong class="text-white"><i class="fa fa-print text-white"></i> Cetak</strong></a>
        <a class="btn btn-sm btn-info mt-2 ml-2" href="<?= base_url('surat_masuk/filter_period'); ?>"><strong class="text-white"><i class="fa fa-print text-white"></i> Cetak Per Periode</strong></a>
...
<div class="card col-lg-12 table-responsive mt-3">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?= $s['no_agenda']; ?></td>
                            <td><?= format_indo($s['tgl_diterima']); ?></td>
                            <td><?= $s['no_surat']; ?></td>
                            <td><?= $s['isi']; ?></td>
                            <td><?= $s['pengirim']; ?></td>
