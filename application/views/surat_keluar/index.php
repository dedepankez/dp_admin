                ...
                <div class="col">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="<?= base_url('surat_keluar/tambah'); ?>" class="btn btn-primary shadow-sm"><i class="fas fa-fw fa-plus"></i> Tambah Data</a>

                            <!-- <a href="<?= base_url('surat_keluar/print'); ?>" class="btn btn-sm btn-outline-secondary shadow-sm ml-1">Print <i class="fa fa-print"></i></a> -->
...
<!-- Modal Hapus -->
            ...
            <form action="<?= base_url('surat_keluar/hapus'); ?>" method="post">
