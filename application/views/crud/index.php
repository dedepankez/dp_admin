...
<div class="row mt-4">
        <div class="col-12">
                ...
                <div class="col">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="<?= base_url('crud/tambah'); ?>" class="btn btn-primary shadow-sm"><i class="fas fa-fw fa-plus"></i> Tambah Data</a>

                            <a href="<?= base_url('crud/print'); ?>" class="btn btn-sm btn-outline-secondary shadow-sm ml-1">Print <i class="fa fa-print"></i></a>

                            <form action="<?= base_url('export/excelsm') ?>" method="post" class="d-inline-block">
                                <button type="submit" name="excel" class="btn btn-sm btn-outline-success shadow-sm ml-3">Excel <i class="fa fa-file-excel"></i></button>
                            </form>
            ...
            <form action="<?= base_url('crud/hapus'); ?>" method="post">
